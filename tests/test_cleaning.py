...
def test_pipeline_final_with_cleaning(bati_raw, boundary_poly, strict_boundary_poly, config):
    ...
    # 2. Nettoyage final
    final_gdf = clip_to_strict_boundary(pop_ventilee, strict_boundary_poly)
